                                    ...
                                    <c:forEach var="order" items="${orders}">
                                        ...
                                        <c:forEach var="orderProduct" items="${order.orderProducts}">
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="mb-0 mt-4">
                                                        <a href="/product/${orderProducts.product.id}" target="_blank">
                                                ...
                                                <td>
                                                    <p class="mb-0 mt-4">
                                                        <fmt:formatNumber type="number" value="${orderProduct.price}" />
                                                        $
                                                    </p>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <p class="mb-0 mt-4" data-cart-detail-id="${orderProduct.id}">
